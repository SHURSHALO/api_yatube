## Описание
Проект "Social Media API" представляет собой API для социальной сети, разработанный с использованием Django и Django REST framework. Этот API предоставляет возможность пользователям создавать, просматривать и взаимодействовать с постами, группами и комментариями. API требует аутентификации по токену TokenAuthentication, что обеспечивает безопасность пользовательских данных.
